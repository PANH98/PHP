...
#Crea los modulos a configurar#
	$modulos=["usuario","categoria","producto"];
# in_array realiza la busqueda del texto dentro de un arreglo#
...
#Evita la inyección SQL#
			...
			if($txt==""){
				...
				#No permite los caracteres no declarados#
				...
				#El texto debe verificar los datos#
				else{
